...
namespace MobileShopFinalAssesement.Controllers
{
    public class BuyersController : Controller
    {
        ...
        public BuyersController(MobileShopFinalAssesementContext context)
        {
            _context = context;
        }
        [Authorize]
        ...
        {
            var mobileShopFinalAssesementContext = _context.Buyer.Include(b => b.Seller_ID);
            return View(await mobileShopFinalAssesementContext.ToListAsync());
        }
